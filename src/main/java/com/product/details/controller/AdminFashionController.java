...
public class AdminFashionController {
	...
	@RequestMapping(value = "/insertFashionProduct", method = RequestMethod.POST)
	...
	@SuppressWarnings("unchecked")
	@RequestMapping(value = "/updateFashionProduct", method = RequestMethod.POST)
